...
@media(max-width:480px){h1{font-size:1.6rem!important;}}
${extraCSS||''}
</style>
</head>
<body>${body}</body>
...
@media(max-width:480px){.hero-h1{font-size:1.6rem!important;}}
</style>
</head>
<body>
...
<section style="position:relative;min-height:92vh;display:flex;flex-direction:column;justify-content:flex-end;overflow:hidden;">
  ...
  <div style="position:relative;z-index:2;padding:0 36px 52px;max-width:800px;" class="sec">
    ...
    <h1 style="font-family:'Barlow Condensed',sans-serif;font-size:clamp(1.8rem,5vw,3rem);font-weight:800;line-height:.93;color:#fff;margin-bottom:16px;" class="fu d1 hero-h1">${headline(copy.hero_headline,'#7EB3FF')}</h1>
...
function templateGrooming(place, copy, photos) {
  ...
  <div style="padding:44px 36px 52px;max-width:660px;margin:0 auto;text-align:center;" class="mob-pad">
    ...
    <h1 style="font-family:'Cormorant Garamond',serif;font-size:clamp(1.8rem,5vw,3rem);font-weight:700;line-height:1.0;margin-bottom:22px;" class="fu d1">
...
function templateWellness(place, copy, photos) {
  ...
  <div style="position:relative;min-height:540px;display:flex;align-items:flex-end;overflow:hidden;">
    ...
    <div style="position:relative;z-index:2;padding:0 36px 52px;max-width:720px;" class="mob-pad">
      ...
      <h1 style="font-family:'Cormorant Garamond',serif;font-size:clamp(1.8rem,5vw,3rem);font-weight:700;line-height:1.08;color:#fff;margin-bottom:18px;" class="fu d1">${headline(copy.hero_headline,'#C8D8B8')}</h1>
...
function templatePet(place, copy, photos) {
  ...
  <div style="padding:52px 32px 42px;max-width:860px;margin:0 auto;" class="mob-pad">
    ...
    <h1 style="font-size:clamp(1.8rem,5vw,3rem);font-weight:800;line-height:1.08;margin-bottom:16px;" class="fu d1">
      ${headline(copy.hero_headline,ACCENT)}
    </h1>
...
function templateRetail(place, copy, photos) {
  ...
  <div style="padding:58px 36px 46px;max-width:860px;margin:0 auto;" class="mob-pad">
    ...
    <h1 style="font-family:'Playfair Display',serif;font-size:clamp(1.8rem,5vw,3rem);font-weight:800;line-height:1.08;margin-bottom:20px;" class="fu d1">
      ${headline(copy.hero_headline,ACCENT)}
    </h1>
...
function templateRealEstate(place, copy, photos) {
  ...
  <div style="padding:62px 36px 50px;max-width:960px;margin:0 auto;" class="mob-pad">
    ...
    <h1 style="font-family:'Libre Baskerville',serif;font-size:clamp(1.8rem,5vw,3rem);font-weight:700;line-height:1.1;color:${TEXT};margin-bottom:20px;" class="fu d1">${headline(copy.hero_headline,ACCENT)}</h1>
